...
namespace WideWorldImporters.API.UnitTests
{
    ...
    {
        public static void Seed(this WideWorldImportersDbContext
        dbContext)
        {
            ...
            LastEditedBy = 1,
                ValidFrom = Convert.ToDateTime("5/31/2016 11:11:00 PM", culture),
                ValidTo = Convert.ToDateTime("12/31/9999 11:59:59 PM", culture)
            });
            dbContext.StockItems.Add(new StockItem
            {
                StockItemID = 2,
            ...
            dbContext.StockItems.Add(new StockItem
            {
                ...
                LastEditedBy = 1,
                ValidFrom = Convert.ToDateTime("5/31/2016 11:00:00 PM", culture ),
                ValidTo = Convert.ToDateTime("12/31/9999 11:59:59 PM", culture)
            });
            dbContext.StockItems.Add(new StockItem
            {
