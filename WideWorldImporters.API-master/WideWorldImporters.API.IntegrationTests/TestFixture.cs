    ...
    public class TestFixture<TStartup> : IDisposable
    {
        ...
        Assembly startupAssembly)
        {
            ...
            do
            {
                ...
                DirectoryInfo(Path.Combine(directoryInfo.FullName, projectRelativePath));
                if (projectDirectoryInfo.Exists)
                    if (new
                    FileInfo(Path.Combine(projectDirectoryInfo.FullName, projectName,
...
new ViewComponentFeatureProvider()
        ...
        protected TestFixture(string relativeTargetProjectParentDir)
        {
            ...
            typeof(TStartup).GetTypeInfo().Assembly;
            var contentRoot =
            GetProjectPath(relativeTargetProjectParentDir, startupAssembly);
